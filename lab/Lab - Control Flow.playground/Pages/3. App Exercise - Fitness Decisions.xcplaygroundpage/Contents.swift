 ...
 */
var questionsCorrect = 19
let totalPoints = 20
if(questionsCorrect/totalPoints < 14){ print("You still need to study this more.")} else if(questionsCorrect/totalPoints < 18){ print("You passed, but you should consider studying a bit more.")} else{ print("Great job! Move on to the next topic.")}

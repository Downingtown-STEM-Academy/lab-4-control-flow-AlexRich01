...
let hasPizza = false
let hasVegan = true
if((hasFish || hasPizza) && hasVegan){ print("Let's go!")} else{ print("Sorry, we'll have to think of somewhere else.")}
/*:
...
print("I will go for a walk for the first and last set of conditions.")
